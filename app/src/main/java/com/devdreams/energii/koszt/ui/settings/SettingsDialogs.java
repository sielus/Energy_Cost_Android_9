...
public class SettingsDialogs {
        ...
        buttonDialogAccept.setOnClickListener(new View.OnClickListener() {
            ...
            private boolean checkInputValue() {
                ...
                if (deviceName.trim().isEmpty()) {
                    ...
                    text_field_inputEditTextDeviceNameLayout.setError(view.getResources().getString(R.string.error_name_canot_start_from_white_space));
                    isNotEmpty = false;
                } else {
    ...
    public void showUpdateDialog(final View view, final String oldDeviceName, final SettingsListAdapter settings_listAdapter){
        ...
        TextWatcher roomPowerTextWatcher = new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
        ...
        TextWatcher roomNumberTextWatcher = new TextWatcher() {
            @Override
            public void beforeTextChanged(CharSequence s, int start, int count, int after) {
