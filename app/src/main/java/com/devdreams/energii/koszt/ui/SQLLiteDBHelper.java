...
public class SQLLiteDBHelper extends SQLiteOpenHelper {
    ...
    private final String defaultDeviceTable =
    ...
    private final String defaultDevice = "INSERT INTO default_device_settings (name, power_value, work_time, device_number) values (?, 15, \"2:0\", 1)," +
            "(?, 0.1, \"24:0\", 1)," +
            "(?, 35, \"24:0\", 1)," +
            "(?, 8, \"7:0\", 1)," +
            "(?, 20, \"7:0\", 1)," +
